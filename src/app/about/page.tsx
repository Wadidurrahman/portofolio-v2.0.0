        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-5 text-slate-600 text-lg leading-relaxed">
              <p>
                <strong>S1 Informatika</strong> dari Universitas Alma Ata Yogyakarta. Saya fokus membangun aplikasi web modern menggunakan <strong>Next.js</strong> dan <strong>Laravel</strong>, dengan ketertarikan khusus pada integrasi <strong>AI</strong>.
              </p>
              <p>
